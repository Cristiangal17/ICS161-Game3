...
public class Two_UseItem : MonoBehaviour {
	...
	void Update () {
        if (Input.GetKeyDown(KeyCode.Q))
        {
            ...
            if  (item == "Bolt")
            {
                GetComponent<Two_CharacterMove>().setCurrSpeedTime(0);
                GetComponent<Two_CharacterMove>().setHasSpeed(true);
